      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center">
            <button
              onClick={toggleTheme}
              className={`w-[56px] h-[28px] relative rounded-full p-[2px] transition-colors duration-500 ${
                isDark 
                  ? 'bg-gray-700' 
                  : 'bg-gray-200'
              }`}
            ...
            >
              <div
                className={`absolute w-[24px] h-[24px] rounded-full transform transition-transform duration-500 flex items-center justify-center ${
                  isDark
                    ? 'translate-x-[28px] bg-gray-800 shadow-[0_0_10px_rgba(147,197,253,0.3)]'
                    : 'translate-x-0 bg-white shadow-[0_0_10px_rgba(250,204,21,0.3)]'
                } hover:scale-105`}
              >
                {isDark ? (
